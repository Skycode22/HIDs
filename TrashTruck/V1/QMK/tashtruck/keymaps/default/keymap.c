...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_DOT,  KC_SLSH, KC_BSLS, KC_GRV,  KC_1,    KC_2,    KC_3,    KC_UP,   KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,  KC_MINS, KC_EQL,  KC_0,    MO(1),   KC_LEFT, KC_DOWN, KC_SPC
    ),
    [1] = LAYOUT(
