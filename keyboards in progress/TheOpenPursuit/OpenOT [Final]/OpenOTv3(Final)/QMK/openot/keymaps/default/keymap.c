...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        KC_ESC,  _______, KC_UP, _______, _______, _______, _______, _______, _______, _______, KC_BSPC, 
        KC_TAB,  KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______, _______, _______, _______, _______, _______, 
