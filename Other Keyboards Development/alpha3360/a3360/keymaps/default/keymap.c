...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_LALT, KC_LCTL, KC_H,    KC_J,    KC_K,    KC_L,    MO(1),   KC_BTN2,  
    ...
    [1] = LAYOUT(
        ...
        KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_TAB,  KC_DEL,  KC_F6,   KC_F7,   KC_F8,   KC_F9,   _______, _______, 
        KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_GRV,  _______, KC_SCLN, KC_QUOT, _______, _______, KC_BSLS, _______  
    ),
